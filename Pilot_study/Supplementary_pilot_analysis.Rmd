...
dataVal$Taste_diff.z = scale(dataVal$Taste_diff)
dataVal$Size_diff.z = scale(dataVal$Size_diff)
dataVal$RT.z = scale(dataVal$RT)

dataPer = tab1[Cue_Taste1_Size2 == 2]
dataPer$Size_diff.z = scale(dataPer$Size_diff)
dataPer$Taste_diff.z = scale(dataPer$Taste_diff)
dataPer$RT.z = scale(dataPer$RT)
