...
tab1$Size_diff.abs = scale(abs(tab1$Size_diff))
tab1$Taste_diff.abs = scale(abs(tab1$Taste_diff))
...
dataVal2$Stim = 1
idx = which(dataVal2$Session_type==0)         #Stim variable: active/sham sessions
dataVal2$Stim[idx] = -1
...
dataPer2$Stim = 1
idx = which(dataPer2$Session_type==0)         #Stim variable: active/sham sessions
dataPer2$Stim[idx] = -1
...
dataVal2 = dataVal[idx,]
dataVal2$Block = 1
idx = which(dataVal2$Trial_Nr>=113)            # Block variable: first 112 and last 64 trials
dataVal2$Block[idx] = -1
...
dataPer2 = dataPer[idx,]
dataPer2$Block = 1
idx = which(dataPer2$Trial_Nr>=113)            # Block variable: first 112 and last 64 trials
dataPer2$Block[idx] = -1
